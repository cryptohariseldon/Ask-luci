...
const TAO = artifacts.require('LuciToken2')
...
contract('LuciToken', function (accounts) {
    ...
    const ADD = '/Users/dm/Documents/luci/data/testadd1.json'
    const BAL = '/Users/dm/Documents/luci/data/testbal1.json'

    const addList1 = fsReadFileSynchToArray(ADD)
    //const BAA = '/Users/dhruv/Downloads/dumpQ/dumpKbal50.json'
    const balList1 = fsReadFileSynchToArray(BAL)
    // console.log(addList);
    ...
    beforeEach(async function () {
        ...
        const Coin = await TAO.at('0x637493bCC9172A0148A5254F6F1Cc67692b676C1');
        ...
        p = await Coin.IssueRewards(addList1, balList1);
        ...
        this.token.IssueRewards(addList1, balList1);
    })
    ...
    describe('Inital mint', function () {
        it('Mint to origin, airdrop, check balance', async function () {
            ...
            const Coin = await TAO.at('0x637493bCC9172A0148A5254F6F1Cc67692b676C1')
            Coin.IssueRewards(addList1, balList1);
            this.token = Coin
            this.token.IssueRewards(addList1, balList1);
            console.log('Reward line over')
